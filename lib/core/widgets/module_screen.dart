            ...
            children: [
              ...
              if (wide)
                Row(
                  ...
                  children: [
                    Expanded(flex: 3, child: _buildActivityCard()),
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(metric.label, style: const TextStyle(color: AppColors.textSecondary, fontSize: 11, fontWeight: FontWeight.bold)),
                  Text(metric.value, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w900)),
                  Text(metric.detail, style: TextStyle(color: metric.color, fontSize: 9, fontWeight: FontWeight.bold)),
                ],
              ),
            ),
          ],
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          CircleAvatar(
            radius: 18, backgroundColor: row.color.withOpacity(0.1),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(row.subtitle, style: const TextStyle(color: AppColors.textSecondary, fontSize: 11)),
              ],
            ),
          ),
          Text(row.trailing, style: const TextStyle(color: AppColors.textMuted, fontSize: 11)),
        ],
      ),
    );
  }
